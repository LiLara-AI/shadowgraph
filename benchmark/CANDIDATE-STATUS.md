...
`tools/mutate.cjs` to remove one guard at a time and count failures. It aborts
if a mutation's anchor stops matching, if fewer than eight measurements land, or
