...
export function createShadowGraph(options = {}) {
  ...
  function purgeProject(project) {
    ...
    return { project, removed: removed.size };
  }
  ...
  return { addDecision, addAttempt, addFact, setOutcome, updateDecisionStatus, supersedeDecision, link, traverse, redact, purgeProject, review, search, context, exportData, importData, stats };
}
