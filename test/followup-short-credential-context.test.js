...
test('short subprocess credentials close their bounded execution artifact across retained evidence', async () => {
  const directory = await mkdtemp(join(tmpdir(), 'shadowgraph-short-credential-context-'));
  try {
